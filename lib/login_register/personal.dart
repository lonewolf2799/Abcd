           ...
           child: SingleChildScrollView(
             child: Column(
               children: [
                 ...
                 {
                    return await Cities.getsuggestions(pattern);
                 },
...
class Cities {
  static final List<String> citylist = [
    "Achalpur",
    "Achhnera",
    "Adalaj",
    "Adilabad",
  ...
  static List<String> getsuggestions (String str)
  {
  List<String> matches = [];
  if(str.isEmpty)
    {
   ...
   matches.retainWhere((element) => element.toLowerCase().contains(str.toLowerCase()));
   int k = 4;
   if(matches.length < k)
     {
       k = matches.length;
